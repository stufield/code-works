...
### Create initial population & survivorships for genotypes ################
...
test.vec;
lambda.vec;
proportions=c(rep(0,6)); proportions[1]=prop.jRR; proportions[2]=prop.jRr; proportions[3]=prop.jrr;
...
par(mfrow=c(1,3))
plot(1:n, popn.matrix[,1],'l', ylim=range(0,8), xlab="Year",ylab="Whitebark Pine Population RR",col='dark red',lwd=2)
...
plot(1:n, popn.matrix[,4],'l', ylim=range(0,8), xlab="Year",ylab="Whitebark Pine Population Rr", col='dark red',lwd=2)
lines(1:n, popn.matrix[,5], 'l', col='dark blue',lwd=2)
lines(1:n, popn.matrix[,6], 'l', col='dark green',lwd=2)
text(4,6,'Red = Newborns'); text(4,5.5,'Blue = Juveniles'); text(4,5,'Green = Adults')
plot(1:n, popn.matrix[,7],'l', ylim=range(0,8), xlab="Year",ylab="Whitebark Pine Population rr", col='dark red',lwd=2)
