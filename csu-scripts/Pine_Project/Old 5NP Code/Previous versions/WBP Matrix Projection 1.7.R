...
Init.Props <- initial.pop/(sum(initial.pop)-(initial.pop[1]+initial.pop[4]+initial.pop[7]+
initial.pop[10]+initial.pop[13]+initial.pop[16]))

p.jRR = Init.Props[2]; p.jRr = Init.Props[5]; p.jrr = Init.Props[8]
p.aRR = Init.Props[3]; p.aRr = Init.Props[6]; p.arr = Init.Props[9]
p.ijRR = Init.Props[11]; p.ijRr = Init.Props[14]; p.ijrr = Init.Props[17]
p.iaRR = Init.Props[12]; p.iaRr = Init.Props[15]; p.iarr = Init.Props[18]
...
####################################################################################
Props <- popn.matrix[n-1,]/(sum(popn.matrix[n-1,])-(popn.matrix[n-1,1]+popn.matrix[n-1,4]+
     popn.matrix[n-1,7]+popn.matrix[n-1,10]+popn.matrix[n-1,13]+popn.matrix[n-1,16]))
	p.jRR = Props[2]; p.jRr = Props[5]; p.jrr = Props[8]
	p.aRR = Props[3]; p.aRr = Props[6]; p.arr = Props[9]
	p.ijRR = Props[11]; p.ijRr = Props[14]; p.ijrr = Props[17]
	p.iaRR = Props[12]; p.iaRr = Props[15]; p.iarr = Props[18]
####################################################################################
	...
	par.matrix[n,11] = FJi*(p.ijRR*((p.jRR*1)+(p.jRr*0.5)+(p.aRR*1)+(p.aRr*0.5)+
				(p.ijRR*1)+(p.ijRr*0.5)+(p.iaRR*1)+(p.iaRr*0.5)))  #*(sample(random,1))
	par.matrix[n,12] = FAi*(p.iaRR*((p.aRR*1)+(p.aRr*0.5)+(p.jRR*1)+(p.jRr*0.5)+
				(p.iaRR*1)+(p.iaRr*0.5)+(p.ijRR*1)+(p.ijRr*0.5)))  #*(sample(random,1))
	par.matrix[n,14] = FJi*(p.ijRr*((p.jRR*0.5)+(p.jRr*0.25)+(p.aRR*0.5)+(p.aRr*0.25)+
				(p.ijRR*0.5)+(p.ijRr*0.25)+(p.iaRR*0.5)+(p.iaRr*0.25)))  #*(sample(random,1))
	par.matrix[n,15] = FAi*(p.iaRr*((p.aRR*0.5)+(p.aRr*0.25)+(p.jRR*0.5)+(p.jRr*0.25)+
				(p.iaRR*0.5)+(p.iaRr*0.25)+(p.ijRR*0.5)+(p.ijRr*0.25)))  #*(sample(random,1))
	...
	par.matrix[n,63] = FA*(p.arr*((p.aRR*1)+(p.aRr*0.5)+(p.jRR*1)+(p.jRr*0.5)+
				(p.iaRR*1)+(p.iaRr*0.5)+(p.ijRR*1)+(p.ijRr*0.5)))  #*(sample(random,1))
	par.matrix[n,65] = FJi*(p.ijRR*((p.jRr*0.5)+(p.jrr*1)+(p.aRr*0.5)+(p.arr*1)+
				(p.ijRr*0.5)+(p.ijrr*1)+(p.iaRr*0.5)+(p.iarr*1)))  #*(sample(random,1))
	par.matrix[n,66] = FAi*(p.iaRR*((p.aRr*0.5)+(p.arr*1)+(p.jRr*0.5)+(p.jrr*1)+
				(p.iaRr*0.5)+(p.iarr*1)+(p.ijRr*0.5)+(p.ijrr*1)))  #*(sample(random,1))
	par.matrix[n,67] = SLinRr*a      ##a.nRr
	par.matrix[n,68] = FJi*(p.ijRr*((p.jRr*0.5)+(p.jrr*0.5)+(p.jRR*0.5)+(p.aRr*0.5)+(p.aRR*0.5)+(p.arr*0.5)+
				(p.ijRr*0.5)+(p.ijrr*0.5)+(p.ijRR*0.5)+(p.iaRr*0.5)+(p.iaRR*0.5)+(p.iarr*0.5)))
                      #*(sample(random,1))
	par.matrix[n,69] = FAi*(p.iaRr*((p.aRr*0.5)+(p.arr*0.5)+(p.aRR*0.5)+(p.jRr*0.5)+(p.jRR*0.5)+(p.jrr*0.5)+
				(p.iaRr*0.5)+(p.iarr*0.5)+(p.iaRR*0.5)+(p.ijRr*0.5)+(p.ijRR*0.5)+(p.ijrr*0.5)))
                      #*(sample(random,1))
	...
	par.matrix[n,117] = FA*(p.arr*((p.arr*1)+(p.aRr*0.5)+(p.jrr*1)+(p.jRr*0.5)+
				(p.iarr*1)+(p.iaRr*0.5)+(p.ijrr*1)+(p.ijRr*0.5)))  #*(sample(random,1))
	par.matrix[n,122] = FJi*(p.ijRr*((p.jRr*0.25)+(p.jrr*0.5)+(p.aRr*0.25)+(p.arr*0.5)+
				(p.ijRr*0.25)+(p.ijrr*0.5)+(p.iaRr*0.25)+(p.iarr*0.5)))  #*(sample(random,1))
	par.matrix[n,123] = FAi*(p.iaRr*((p.aRr*0.25)+(p.arr*0.5)+(p.jRr*0.25)+(p.jrr*0.5)+
				(p.iaRr*0.25)+(p.iarr*0.5)+(p.ijRr*0.25)+(p.ijrr*0.5)))  #*(sample(random,1))
...
lambda.vec;
freq.R; freq.r
Mating.Props=c(Props[2:3],Props[5:6],Props[8:9],Props[11:12],
             Props[14:15],Props[17:18]); Mating.Props; sum(Mating.Props)
